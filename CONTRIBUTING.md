...
Fork [MinIO upstream](https://github.com/RTradeLtd/s3x/fork) source repository to your own personal repository. Copy the URL of your MinIO fork (you will need it for the `git clone` command below).
