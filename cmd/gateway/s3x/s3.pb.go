...
type MultipartUpload struct {
	...
	//map of etag to parts
	ObjectParts map[string]ObjectPartInfo `protobuf:"bytes,4,rep,name=objectParts,proto3" json:"objectParts" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *MultipartUpload) GetObjectParts() map[string]ObjectPartInfo {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]ObjectPartInfo)(nil), "s3x.MultipartUpload.ObjectPartsEntry")
}
...
var fileDescriptor_005e34be4304e022 = []byte{
	...
	0x14, 0x4f, 0xcf, 0x64, 0xfe, 0xe4, 0xcd, 0x6c, 0x32, 0x29, 0xd7, 0xa5, 0x68, 0x64, 0x32, 0xb6,
	...
	,
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.ObjectParts == nil {
				m.ObjectParts = make(map[string]ObjectPartInfo)
			}
			var mapkey string
