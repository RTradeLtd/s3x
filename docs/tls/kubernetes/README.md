...
For testing purposes, here is [how to create self-signed certificates](https://github.com/RTradeLtd/s3x/tree/master/docs/tls#3-generate-self-signed-certificates).
